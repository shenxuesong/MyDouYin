...
import com.shenxuesong.mydouyin.persenter.BannerPersenter;
import com.shenxuesong.mydouyin.persenter.HotPersenter;
...
private SearchPersenter searchPersenter;
    ...
    private HotPersenter hotPersenter;
    private int count=5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search);
         ...
         bannerPersenter = new BannerPersenter(this);
         bannerPersenter.getBannerBean();
         hotPersenter = new HotPersenter(this);
